        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed">
              Leading digital marketing agency focused on driving measurable
              results and sustainable growth for modern brands.
            </p>
            <div className="flex gap-4">
              <a
                href="#"
                className="p-2 bg-white/10 rounded-full hover:bg-primary transition-smooth"
              >
                <FaFacebook size={20} />
              </a>
              <a
          ...
          {/* Services */}
          <div>
            <h4 className="text-lg font-bold mb-6 underline decoration-accent underline-offset-8">
              Our Services
            </h4>
            <ul className="space-y-4">
              {serviceLinks.map((service) => (
                <li key={service}>
                  <Link
                    to="/services"
                    className="text-gray-300 hover:text-accent transition-smooth"
                  >
                    {service}
                  </Link>
                </li>
